...
class DeliveryCarrier(models.Model):
    ...
    def shiprocket_order_request_data(self, picking):
        ...
        request_data = {
            ...
            "length": "{}".format(self.shiprocket_packaging_id and self.shiprocket_packaging_id.length or 0.0),
            "breadth": "{}".format(self.shiprocket_packaging_id and self.shiprocket_packaging_id.width or 0.0),
            "height": "{}".format(self.shiprocket_packaging_id and self.shiprocket_packaging_id.height or 0.0),
